...
<body>
    ...
    <div class="row">
        ...
        <div class="jumbotron text-center">
            ...
            <form method="post" action="controleur.php?action=checkCode" id="form">
            <div class="col-md-9 col-sm-12">
                <div class="form-group form-group-lg">
                <input type="number" class="form-control col-md-6 col-sm-6 col-sm-offset-2" name="verifyCode" required>
                <input class="btn btn-primary" type="submit" value="Verifiez">
                </div>
            </div>
            </form>
        </div>
...
<script>
        ...
        $( "#form" ).submit(function( event ) {
          ...
          var posting = $.post( url, { verifyCode:term.verifyCode } );
